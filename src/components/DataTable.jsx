                                    ...
                                    isLoggedIn ?
                                        <>
                                            {BlogData?.map((data, key) => (
                                                <tr key={key}>
                                                    <td>
                                                        <img src={`http://localhost:8000/images/coverimage/${data?.CoverImage}`} alt="errror-icon" />
                                                    </td>
                                                    <td>
                                        ...
                                        <>
                                            {BlogData[activeCard]?.map((data, key) => (
                                                <tr key={key}>
                                                    <td>
                                                        <img src={`http://localhost:8000/images/${data?.CoverImage? "coverimage" : "userprofile"}/${data?.CoverImage??data?.ProfilePicture}`} alt="errror-icon" />
                                                    </td>
